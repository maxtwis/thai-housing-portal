...
import { usePopulationData } from '../../hooks/useCkanQueries';

const PopulationChart = ({ provinceName, provinceId }) => {
  ...
  // Formatter for population numbers
      ...
      <div className="px-3 py-2 border-b border-gray-200">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <ExportButton data={data} filename={`population_${provinceName}`} />
          </div>
        </div>
      </div>
